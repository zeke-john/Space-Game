...
wn = turtle.Screen()
wn.bgcolor("black")
wn.bgpic("res/images/wp3284832.gif")
wn.title("Space Game")
wn.tracer()
...
player.color("blue")
player.shape("res/images/player.gif")
player.penup()
player.speed(0)
...
enemy = turtle.Turtle()
enemy.color("red")
enemy.shape("res/images/enemy.gif")
enemy.penup()
enemy.speed(0)
...
while True:
    ...
    if bullet.distance(enemy) < 27.5:
        winsound.PlaySound("res/sounds/cartoon007.wav", winsound.SND_ASYNC)
        Score +=1
        pen.clear()
        pen.goto(0, 260)
    ...
    if level == 2:
        enemy.shape("res/images/2nd_enemy.gif")
        pen.goto(0, 260)
        pen.write("Score: {}".format(Score), align="center", font=("Courier", 24, "normal")) 
        pen.goto(0, 240)
        pen.write("Press Alt to pause", align="center", font=("Courier", 12, "normal"))
    ...
    if level == 3:
        enemy.shape("res/images/3nd_enemy.gif")
        pen.goto(0, 260)
        pen.write("Score: {}".format(Score), align="center", font=("Courier", 24, "normal")) 
        pen.goto(0, 240)
        pen.write("Press Alt to pause", align="center", font=("Courier", 12, "normal"))
